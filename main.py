...
def main_menu():
    ...
    pygame.mixer.music.load("./resources/sound/main.mp3")  # 배경음악
    pygame.mixer.music.play(-1)  # 배경음악재생
    menu = True
    selected = "start"
    background2 = pygame.image.load("./resources/메인메뉴.jpeg")
    while menu:
        ...
        if selected == "start":
            text_start = pygame.image.load('./resources/start2.png')
        else:
            text_start = pygame.image.load('./resources/start.png')
        if selected == "quit":
            text_quit = pygame.image.load('./resources/quit2.png')
        else:
            text_quit = pygame.image.load('./resources/quit.png')
...
# 미사일 종류
missile1 = ["./resources/paper1.png", "./resources/paper2.png", "./resources/paper3.png"]
missile2 = ['./resources/missile.png', './resources/missile1.png']  # ehkoo
...
# 파이터
fighter = [pygame.image.load('./resources/fighter0.png'), pygame.image.load('./resources/fighter1.png'), pygame.image.load('./resources/fighter2.png'),
           pygame.image.load('./resources/fighter3.png'),
           pygame.image.load('./resources/fighter4.png')]

# 파이터 움직이는 카운트
fighterCount = 0

# 운석 종류
rockImage = ['./resources/왓챠.png', './resources/쿠팡.png', './resources/넷플.png', './resources/디즈니.png']
rockImage2 = ['./resources/apple.png', './resources/benz.png', './resources/bmw.png', './resources/chanel.png']

# 폭발 소리
explosionSound = ["./resources/sound/짤랑.mp3"]
...
def initGame():
    ...
    explosion_boss = pygame.image.load("./resources/보스폭발.jpg")
    boss = pygame.image.load("./resources/보스.png")  ##
    ending_img = pygame.image.load("./resources/ending_img.png")
    # 돈다발 객체
    money = pygame.image.load("./resources/bg_money.png")

    # 소리
    winSound = pygame.mixer.Sound("./resources/sound/우승.mp3")
    selectSound = pygame.mixer.Sound("./resources/sound/선택.mp3")
    stageSound = pygame.mixer.Sound("./resources/sound/클리어.mp3")

    levelupSound = pygame.mixer.Sound("./resources/sound/레벨업.wav")

    colSound = pygame.mixer.Sound("./resources/sound/충돌.mp3")  # 충돌 사운드
    missileSound = pygame.mixer.Sound("./resources/sound/짤랑.mp3")  # 미사일 사운드
    gameOverSound = pygame.mixer.Sound("./resources/sound/게임오버.mp3")  # 게임 오버 사운드
...
def runGame():
    ...
    # 배경 음악 시작
    pygame.mixer.music.load("./resources/sound/브금1.mp3")  # 배경음악
    pygame.mixer.music.play(-1)  # 배경음악재생
    ## 스테이지1
    stage = 1
